...
// Constants colors :
#define kFlatDatePickerBackgroundColor [UIColor colorWithRed:233.0/255.0 green:233.0/255.0 blue:233.0/255.0 alpha:1.0]
#define kFlatDatePickerBackgroundColorTitle [UIColor colorWithRed:233.0/255.0 green:233.0/255.0 blue:233.0/255.0 alpha:1.0]
#define kFlatDatePickerBackgroundColorScrolView [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0]
#define kFlatDatePickerBackgroundColorLines [UIColor colorWithRed:178.0/255.0 green:178.0/255.0 blue:178.0/255.0 alpha:1.0]

// Constants fonts colors :
#define kFlatDatePickerFontColorTitle [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0]
#define kFlatDatePickerFontColorLabel [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0]
#define kFlatDatePickerFontColorLabelSelected [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0]
#define kFlatDatePickerFontColorBtn [UIColor colorWithRed:0/255.0 green:198/255.0 blue:12/255.0 alpha:1.0]

// Constants sizes :
#define kFlatDatePickerHeight 200
#define kFlatDatePickerHeaderHeight 44
#define kFlatDatePickerButtonHeaderWidth 60
#define kFlatDatePickerHeaderBottomMargin 0
...
#define kFlatDatePickerScrollViewLeftMargin 0
#define kFlatDatePickerScrollViewItemHeight 34
#define kFlatDatePickerLineWidth 1
#define kFlatDatePickerLineMargin 15

// Constants fonts
#define kFlatDatePickerFontTitle [UIFont systemFontOfSize:15.0]
#define kFlatDatePickerFontLabel [UIFont systemFontOfSize:14.0]
#define kFlatDatePickerFontLabelSelected [UIFont systemFontOfSize:14.0]
...
{
    // Label Title
    _labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 0.0, self.frame.size.width, kFlatDatePickerHeaderHeight)];
    ...
    [_buttonClose setTitleColor:kFlatDatePickerFontColorBtn forState:UIControlStateNormal];
    [_buttonClose.titleLabel setFont:kFlatDatePickerFontTitle];
    ...
    [_buttonValid setTitle:@"确定" forState:UIControlStateNormal];
    [_buttonValid setTitleColor:kFlatDatePickerFontColorBtn forState:UIControlStateNormal];
    [_buttonValid.titleLabel setFont:kFlatDatePickerFontTitle];
...
- (NSMutableArray*)getYears
{
    ...
    if (self.minimumDate != nil) {
        ...
        yearMin = (int)[componentsMin year];
    } else {
        yearMin = kStartYear;
    }
    _mmStratYear = yearMin;
    ...
    if (self.maximumDate != nil) {
        ...
        yearMax = (int)[componentsMax year];
    } else {
...
- (NSMutableArray*)getDates {
    ...
    [dateComponents setYear:_mmStratYear];
...
- (void)updateSelectedDateAtIndex:(int)index forScrollView:(UIScrollView*)scrollView {
    ...
    if (scrollView.tag == TAG_DAYS) {
        ...
        _selectedYear = _mmStratYear + index;
...
- (void)setDate:(NSDate *)date animated:(BOOL)animated {
    ...
    if (date != nil) {
        ...
        _selectedDay = (int)[components day];
        _selectedMonth = (int)[components month];
        _selectedYear = (int)[components year];
        _selectedHour = (int)[components hour];
        _selectedMinute = (int)[components minute];
        _selectedSecond = (int)[components second];
        ...
        if (self.datePickerMode == FlatDatePickerModeDate) {
            ...
            [self setScrollView:_scollViewYears atIndex:(_selectedYear - _mmStratYear) animated:animated];
        }
